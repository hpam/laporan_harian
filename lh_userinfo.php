...
//
// Table class for lh_user
//
class clh_user extends cTable {
	var $id_user;
	var $id_level;
	var $username;
	var $password;
	...
	function __construct() {
		...
		$this->TableVar = 'lh_user';
		$this->TableName = 'lh_user';
		...
		// id_user
		$this->id_user = new cField('lh_user', 'lh_user', 'x_id_user', 'id_user', '`id_user`', '`id_user`', 3, -1, FALSE, '`id_user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_user->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_user'] = &$this->id_user;

		// id_level
		$this->id_level = new cField('lh_user', 'lh_user', 'x_id_level', 'id_level', '`id_level`', '`id_level`', 3, -1, FALSE, '`id_level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_level->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_level'] = &$this->id_level;

		// username
		$this->username = new cField('lh_user', 'lh_user', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['username'] = &$this->username;

		// password
		$this->password = new cField('lh_user', 'lh_user', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['password'] = &$this->password;

		// nama
		$this->nama = new cField('lh_user', 'lh_user', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("lh_userview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "lh_useradd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("lh_useredit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("lh_useradd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("lh_userdelete.php", $this->UrlParm());
	}
