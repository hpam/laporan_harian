...
//
// Table class for catat_nota
//
class ccatat_nota extends cTable {
	var $id_dana;
	var $nomor_nota;
	var $nama_toko;
	...
	function __construct() {
		...
		$this->TableVar = 'catat_nota';
		$this->TableName = 'catat_nota';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id_dana
		$this->id_dana = new cField('catat_nota', 'catat_nota', 'x_id_dana', 'id_dana', '`id_dana`', '`id_dana`', 3, 7, FALSE, '`id_dana`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_dana->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_dana'] = &$this->id_dana;

		// nomor_nota
		$this->nomor_nota = new cField('catat_nota', 'catat_nota', 'x_nomor_nota', 'nomor_nota', '`nomor_nota`', '`nomor_nota`', 200, -1, FALSE, '`nomor_nota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nomor_nota'] = &$this->nomor_nota;

		// nama_toko
		$this->nama_toko = new cField('catat_nota', 'catat_nota', 'x_nama_toko', 'nama_toko', '`nama_toko`', '`nama_toko`', 200, -1, FALSE, '`nama_toko`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_toko'] = &$this->nama_toko;

		// jumlah_pembelian
		$this->jumlah_pembelian = new cField('catat_nota', 'catat_nota', 'x_jumlah_pembelian', 'jumlah_pembelian', '`jumlah_pembelian`', '`jumlah_pembelian`', 3, -1, FALSE, '`jumlah_pembelian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// pesan
		$this->pesan = new cField('catat_nota', 'catat_nota', 'x_pesan', 'pesan', '`pesan`', '`pesan`', 201, -1, FALSE, '`pesan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pesan'] = &$this->pesan;

		// tanggal_nota
		$this->tanggal_nota = new cField('catat_nota', 'catat_nota', 'x_tanggal_nota', 'tanggal_nota', '`tanggal_nota`', 'DATE_FORMAT(`tanggal_nota`, \'%m/%d/%Y %H:%i:%s\')', 133, 7, FALSE, '`tanggal_nota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("catat_notaview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "catat_notaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("catat_notaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("catat_notaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("catat_notadelete.php", $this->UrlParm());
	}
