...
// Validate form
fuserlevelpermissionsadd.Validate = function(fobj) {
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevelpermissions->TableCaption() ?></span></p>
...
?>
<form name="fuserlevelpermissionsadd" id="fuserlevelpermissionsadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="userlevelpermissions">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_userlevelpermissionsadd" class="ewTable">
...
<input type="text" name="x_userlevelid" id="x_userlevelid" size="30" value="<?php echo $userlevelpermissions->userlevelid->EditValue ?>"<?php echo $userlevelpermissions->userlevelid->EditAttributes() ?>>
...
<input type="text" name="x__tablename" id="x__tablename" size="30" maxlength="255" value="<?php echo $userlevelpermissions->_tablename->EditValue ?>"<?php echo $userlevelpermissions->_tablename->EditAttributes() ?>>
