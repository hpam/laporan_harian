...
//
// Table class for input proyek
//
class cinput_proyek extends cTable {
	var $id_proyek;
	var $nama_proyek;
	var $tanggal;
	var $kardus;
	...
	function __construct() {
		...
		$this->TableVar = 'input_proyek';
		$this->TableName = 'input proyek';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id_proyek
		$this->id_proyek = new cField('input_proyek', 'input proyek', 'x_id_proyek', 'id_proyek', '`id_proyek`', '`id_proyek`', 3, -1, FALSE, '`id_proyek`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_proyek->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_proyek'] = &$this->id_proyek;

		// nama_proyek
		$this->nama_proyek = new cField('input_proyek', 'input proyek', 'x_nama_proyek', 'nama_proyek', '`nama_proyek`', '`nama_proyek`', 200, -1, FALSE, '`nama_proyek`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_proyek'] = &$this->nama_proyek;

		// tanggal
		$this->tanggal = new cField('input_proyek', 'input proyek', 'x_tanggal', 'tanggal', '`tanggal`', 'DATE_FORMAT(`tanggal`, \'%d/%m/%Y %H:%i:%s\')', 135, 7, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['tanggal'] = &$this->tanggal;

		// kardus
		$this->kardus = new cField('input_proyek', 'input proyek', 'x_kardus', 'kardus', '`kardus`', '`kardus`', 3, -1, FALSE, '`kardus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->kardus->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kardus'] = &$this->kardus;

		// kayu
		$this->kayu = new cField('input_proyek', 'input proyek', 'x_kayu', 'kayu', '`kayu`', '`kayu`', 3, -1, FALSE, '`kayu`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->kayu->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kayu'] = &$this->kayu;

		// besi
		$this->besi = new cField('input_proyek', 'input proyek', 'x_besi', 'besi', '`besi`', '`besi`', 3, -1, FALSE, '`besi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->besi->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['besi'] = &$this->besi;

		// harga
		$this->harga = new cField('input_proyek', 'input proyek', 'x_harga', 'harga', '`harga`', '`harga`', 3, -1, FALSE, '`harga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("input_proyekview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "input_proyekadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("input_proyekedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("input_proyekadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("input_proyekdelete.php", $this->UrlParm());
	}
