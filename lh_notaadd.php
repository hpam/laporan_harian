...
$lh_nota_add = NULL; // Initialize page object first

class clh_nota_add extends clh_nota {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "lh_notaview.php")
...
// Create page object
if (!isset($lh_nota_add)) $lh_nota_add = new clh_nota_add();

// Page init
$lh_nota_add->Page_Init();

// Page main
$lh_nota_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var lh_nota_add = new ew_Page("lh_nota_add");
lh_nota_add.PageID = "add"; // Page ID
var EW_PAGE_ID = lh_nota_add.PageID; // For backward compatibility

// Form object
var flh_notaadd = new ew_Form("flh_notaadd");

// Validate form
flh_notaadd.Validate = function(fobj) {
...
flh_notaadd.Form_CustomValidate = 
...
flh_notaadd.ValidateRequired = true;
<?php } else { ?>
flh_notaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flh_notaadd.Lists["x_id_dana"] = {"LinkField":"x_id_dana","Ajax":null,"AutoFill":false,"DisplayFields":["x_periode_pembiayaan","x_jumlah_dana","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $lh_nota->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $lh_nota->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $lh_nota_add->ShowPageHeader(); ?>
<?php
$lh_nota_add->ShowMessage();
?>
<form name="flh_notaadd" id="flh_notaadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="lh_nota">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_lh_notaadd" class="ewTable">
...
<script type="text/javascript">
flh_notaadd.Lists["x_id_dana"].Options = <?php echo (is_array($lh_nota->id_dana->EditValue)) ? ew_ArrayToJson($lh_nota->id_dana->EditValue, 1) : "[]" ?>;
</script>
...
&nbsp;<img src="phpimages/calendar.png" id="flh_notaadd$x_tanggal_nota$" name="flh_notaadd$x_tanggal_nota$" alt="<?php echo $Language->Phrase("PickDate") ?>" title="<?php echo $Language->Phrase("PickDate") ?>" class="ewCalendar" style="border: 0;">
<script type="text/javascript">
ew_CreateCalendar("flh_notaadd", "x_tanggal_nota", "%d/%m/%Y");
</script>
<?php } ?>
...
<script type="text/javascript">
ew_CreateEditor("flh_notaadd", "x_pesan", 25, 4, <?php echo ($lh_nota->pesan->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
