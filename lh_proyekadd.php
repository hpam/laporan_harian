...
$lh_proyek_add = NULL; // Initialize page object first

class clh_proyek_add extends clh_proyek {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "lh_proyekview.php")
...
// Create page object
if (!isset($lh_proyek_add)) $lh_proyek_add = new clh_proyek_add();

// Page init
$lh_proyek_add->Page_Init();

// Page main
$lh_proyek_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var lh_proyek_add = new ew_Page("lh_proyek_add");
lh_proyek_add.PageID = "add"; // Page ID
var EW_PAGE_ID = lh_proyek_add.PageID; // For backward compatibility

// Form object
var flh_proyekadd = new ew_Form("flh_proyekadd");

// Validate form
flh_proyekadd.Validate = function(fobj) {
...
flh_proyekadd.Form_CustomValidate = 
...
flh_proyekadd.ValidateRequired = true;
<?php } else { ?>
flh_proyekadd.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $lh_proyek->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $lh_proyek->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $lh_proyek_add->ShowPageHeader(); ?>
<?php
$lh_proyek_add->ShowMessage();
?>
<form name="flh_proyekadd" id="flh_proyekadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="lh_proyek">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_lh_proyekadd" class="ewTable">
...
&nbsp;<img src="phpimages/calendar.png" id="flh_proyekadd$x_tanggal$" name="flh_proyekadd$x_tanggal$" alt="<?php echo $Language->Phrase("PickDate") ?>" title="<?php echo $Language->Phrase("PickDate") ?>" class="ewCalendar" style="border: 0;">
<script type="text/javascript">
ew_CreateCalendar("flh_proyekadd", "x_tanggal", "%d/%m/%Y");
</script>
<?php } ?>
