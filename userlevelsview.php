...
class cuserlevels_view extends cuserlevels {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_userlevels\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_userlevels',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
<?php } ?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevels->TableCaption() ?>&nbsp;&nbsp;</span><?php $userlevels_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($userlevels->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $userlevels_view->ListUrl ?>" id="a_BackToList" class="ewLink"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->CanAdd()) { ?>
<?php if ($userlevels_view->AddUrl <> "") { ?>
<a href="<?php echo $userlevels_view->AddUrl ?>" id="a_AddLink" class="ewLink"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->CanEdit()) { ?>
<?php if ($userlevels_view->EditUrl <> "") { ?>
<a href="<?php echo $userlevels_view->EditUrl ?>" id="a_EditLink" class="ewLink"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->CanAdd()) { ?>
<?php if ($userlevels_view->CopyUrl <> "") { ?>
<a href="<?php echo $userlevels_view->CopyUrl ?>" id="a_CopyLink" class="ewLink"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->CanDelete()) { ?>
<?php if ($userlevels_view->DeleteUrl <> "") { ?>
<a href="<?php echo $userlevels_view->DeleteUrl ?>" id="a_DeleteLink" class="ewLink"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
...
?>
<form name="fuserlevelsview" id="fuserlevelsview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="userlevels">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_userlevelsview" class="ewTable">
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid"<?php echo $userlevels->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevels_userlevelid"><table class="ewTableHeaderBtn"><tr><td><?php echo $userlevels->userlevelid->FldCaption() ?></td></tr></table></span></td>
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname"<?php echo $userlevels->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_userlevels_userlevelname"><table class="ewTableHeaderBtn"><tr><td><?php echo $userlevels->userlevelname->FldCaption() ?></td></tr></table></span></td>
