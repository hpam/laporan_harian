...
?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $userlevels->TableCaption() ?></span></p>
...
?>
<form name="fuserlevelsdelete" id="fuserlevelsdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<br>
...
<table id="tbl_userlevelsdelete" class="ewTable ewTableSeparate">
<?php echo $userlevels->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
		<td><span id="elh_userlevels_userlevelid" class="userlevels_userlevelid"><table class="ewTableHeaderBtn"><tr><td><?php echo $userlevels->userlevelid->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_userlevels_userlevelname" class="userlevels_userlevelname"><table class="ewTableHeaderBtn"><tr><td><?php echo $userlevels->userlevelname->FldCaption() ?></td></tr></table></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $userlevels->RowAttributes() ?>>
		<td<?php echo $userlevels->userlevelid->CellAttributes() ?>><span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_userlevelid" class="userlevels_userlevelid">
<span<?php echo $userlevels->userlevelid->ViewAttributes() ?>>
<?php echo $userlevels->userlevelid->ListViewValue() ?></span>
</span></td>
		<td<?php echo $userlevels->userlevelname->CellAttributes() ?>><span id="el<?php echo $userlevels_delete->RowCnt ?>_userlevels_userlevelname" class="userlevels_userlevelname">
