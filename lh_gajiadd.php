...
$lh_gaji_add = NULL; // Initialize page object first

class clh_gaji_add extends clh_gaji {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_gaji"] != "") {
				...
				$this->setKey("id_gaji", $this->id_gaji->CurrentValue); // Set up key
			} else {
				$this->setKey("id_gaji", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "lh_gajiview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$this->id_gaji->setDbValue($conn->Insert_ID());
			$rsnew['id_gaji'] = $this->id_gaji->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($lh_gaji_add)) $lh_gaji_add = new clh_gaji_add();

// Page init
$lh_gaji_add->Page_Init();

// Page main
$lh_gaji_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var lh_gaji_add = new ew_Page("lh_gaji_add");
lh_gaji_add.PageID = "add"; // Page ID
var EW_PAGE_ID = lh_gaji_add.PageID; // For backward compatibility

// Form object
var flh_gajiadd = new ew_Form("flh_gajiadd");

// Validate form
flh_gajiadd.Validate = function(fobj) {
...
flh_gajiadd.Form_CustomValidate = 
...
flh_gajiadd.ValidateRequired = true;
<?php } else { ?>
flh_gajiadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flh_gajiadd.Lists["x_id_user"] = {"LinkField":"x_id_user","Ajax":null,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $lh_gaji->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $lh_gaji->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $lh_gaji_add->ShowPageHeader(); ?>
<?php
$lh_gaji_add->ShowMessage();
?>
<form name="flh_gajiadd" id="flh_gajiadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="lh_gaji">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_lh_gajiadd" class="ewTable">
...
<script type="text/javascript">
flh_gajiadd.Lists["x_id_user"].Options = <?php echo (is_array($lh_gaji->id_user->EditValue)) ? ew_ArrayToJson($lh_gaji->id_user->EditValue, 1) : "[]" ?>;
</script>
...
&nbsp;<img src="phpimages/calendar.png" id="flh_gajiadd$x_tanggal$" name="flh_gajiadd$x_tanggal$" alt="<?php echo $Language->Phrase("PickDate") ?>" title="<?php echo $Language->Phrase("PickDate") ?>" class="ewCalendar" style="border: 0;">
<script type="text/javascript">
ew_CreateCalendar("flh_gajiadd", "x_tanggal", "%d/%m/%Y");
</script>
<?php } ?>
