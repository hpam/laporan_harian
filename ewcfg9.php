...
define("EW_PROJECT_NAME", "lh", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{67264FB2-6364-478B-87DD-B3E0D7A29425}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'y33uDe4Awe2JHOkK', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/lh.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'artjog_harian', TRUE);
...
// User table filters
define("EW_USER_TABLE", "`lh_user`",  TRUE);
