...
class cuserlevelpermissions extends cTable {
	...
	// Add URL
	function GetAddUrl() {
		return "userlevelpermissionsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("userlevelpermissionsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("userlevelpermissionsadd.php", $this->UrlParm($parm));
	}
