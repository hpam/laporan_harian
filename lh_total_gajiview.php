...
$lh_total_gaji_view = NULL; // Initialize page object first

class clh_total_gaji_view extends clh_total_gaji {
	...
	// Page object name
	var $PageObjName = 'lh_total_gaji_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_gaji"] <> "") {
				...
				$sReturnUrl = "lh_total_gajilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lh_total_gajilist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lh_total_gajilist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_lh_total_gaji\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_lh_total_gaji',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($lh_total_gaji_view)) $lh_total_gaji_view = new clh_total_gaji_view();

// Page init
$lh_total_gaji_view->Page_Init();

// Page main
$lh_total_gaji_view->Page_Main();
?>
...
// Page object
var lh_total_gaji_view = new ew_Page("lh_total_gaji_view");
lh_total_gaji_view.PageID = "view"; // Page ID
var EW_PAGE_ID = lh_total_gaji_view.PageID; // For backward compatibility

// Form object
var flh_total_gajiview = new ew_Form("flh_total_gajiview");

// Form_CustomValidate event
flh_total_gajiview.Form_CustomValidate = 
...
flh_total_gajiview.ValidateRequired = true;
<?php } else { ?>
flh_total_gajiview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeVIEW") ?><?php echo $lh_total_gaji->TableCaption() ?>&nbsp;&nbsp;</span><?php $lh_total_gaji_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($lh_total_gaji->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $lh_total_gaji_view->ListUrl ?>" id="a_BackToList" class="ewLink"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
</p>
<?php } ?>
<?php $lh_total_gaji_view->ShowPageHeader(); ?>
<?php
$lh_total_gaji_view->ShowMessage();
?>
<form name="flh_total_gajiview" id="flh_total_gajiview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="lh_total_gaji">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_lh_total_gajiview" class="ewTable">
<?php if ($lh_total_gaji->id_gaji->Visible) { // id_gaji ?>
	<tr id="r_id_gaji"<?php echo $lh_total_gaji->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_lh_total_gaji_id_gaji"><table class="ewTableHeaderBtn"><tr><td><?php echo $lh_total_gaji->id_gaji->FldCaption() ?></td></tr></table></span></td>
		<td<?php echo $lh_total_gaji->id_gaji->CellAttributes() ?>><span id="el_lh_total_gaji_id_gaji">
<span<?php echo $lh_total_gaji->id_gaji->ViewAttributes() ?>>
<?php echo $lh_total_gaji->id_gaji->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($lh_total_gaji->nama->Visible) { // nama ?>
	<tr id="r_nama"<?php echo $lh_total_gaji->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_lh_total_gaji_nama"><table class="ewTableHeaderBtn"><tr><td><?php echo $lh_total_gaji->nama->FldCaption() ?></td></tr></table></span></td>
...
<?php echo $lh_total_gaji->nama->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($lh_total_gaji->status->Visible) { // status ?>
	<tr id="r_status"<?php echo $lh_total_gaji->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_lh_total_gaji_status"><table class="ewTableHeaderBtn"><tr><td><?php echo $lh_total_gaji->status->FldCaption() ?></td></tr></table></span></td>
...
<?php echo $lh_total_gaji->status->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($lh_total_gaji->tanggal->Visible) { // tanggal ?>
	<tr id="r_tanggal"<?php echo $lh_total_gaji->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_lh_total_gaji_tanggal"><table class="ewTableHeaderBtn"><tr><td><?php echo $lh_total_gaji->tanggal->FldCaption() ?></td></tr></table></span></td>
...
<?php echo $lh_total_gaji->tanggal->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $lh_total_gaji->gaji_pokok->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $lh_total_gaji->lembur->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $lh_total_gaji->tunjangan_proyek->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $lh_total_gaji->Total_Gaji->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<br>
<script type="text/javascript">
flh_total_gajiview.Init();
</script>
<?php
$lh_total_gaji_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lh_total_gaji->Export == "") { ?>
...
<?php
$lh_total_gaji_view->Page_Terminate();
?>
