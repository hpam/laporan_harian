...
//
// Table class for lh_input_nota
//
class clh_input_nota extends cTable {
	var $id_nota;
	var $id_dana;
	var $nomor_nota;
	var $nama_toko;
	...
	function __construct() {
		...
		$this->TableVar = 'lh_input_nota';
		$this->TableName = 'lh_input_nota';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// id_nota
		$this->id_nota = new cField('lh_input_nota', 'lh_input_nota', 'x_id_nota', 'id_nota', '`id_nota`', '`id_nota`', 3, -1, FALSE, '`id_nota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_nota->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_nota'] = &$this->id_nota;

		// id_dana
		$this->id_dana = new cField('lh_input_nota', 'lh_input_nota', 'x_id_dana', 'id_dana', '`id_dana`', '`id_dana`', 3, 7, FALSE, '`id_dana`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_dana->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_dana'] = &$this->id_dana;

		// nomor_nota
		$this->nomor_nota = new cField('lh_input_nota', 'lh_input_nota', 'x_nomor_nota', 'nomor_nota', '`nomor_nota`', '`nomor_nota`', 200, -1, FALSE, '`nomor_nota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nomor_nota'] = &$this->nomor_nota;

		// nama_toko
		$this->nama_toko = new cField('lh_input_nota', 'lh_input_nota', 'x_nama_toko', 'nama_toko', '`nama_toko`', '`nama_toko`', 200, -1, FALSE, '`nama_toko`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_toko'] = &$this->nama_toko;

		// tanggal_nota
		$this->tanggal_nota = new cField('lh_input_nota', 'lh_input_nota', 'x_tanggal_nota', 'tanggal_nota', '`tanggal_nota`', 'DATE_FORMAT(`tanggal_nota`, \'%d/%m/%Y %H:%i:%s\')', 133, 7, FALSE, '`tanggal_nota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// jumlah_pembelian
		$this->jumlah_pembelian = new cField('lh_input_nota', 'lh_input_nota', 'x_jumlah_pembelian', 'jumlah_pembelian', '`jumlah_pembelian`', '`jumlah_pembelian`', 5, -1, FALSE, '`jumlah_pembelian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->jumlah_pembelian->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['jumlah_pembelian'] = &$this->jumlah_pembelian;

		// pesan
		$this->pesan = new cField('lh_input_nota', 'lh_input_nota', 'x_pesan', 'pesan', '`pesan`', '`pesan`', 201, -1, FALSE, '`pesan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("lh_input_notaview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "lh_input_notaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("lh_input_notaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("lh_input_notaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("lh_input_notadelete.php", $this->UrlParm());
	}
